...
dotbracketinput <- readLines("sample_test_files/HCV_Jc1.dot")[3]
...
shannoninput <- read.table("sample_test_files/HCV_shannon.txt", header = FALSE)
...
#plot histogram of structure counts
```{r}
hist(abinter, xlab = "Nucleotide", ylab = "Structure Counts", main=NULL, breaks = seq(from=-100, to=length(shannon)+100, by=100))
box(col = "black")
```
